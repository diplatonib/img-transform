...
r.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Qa;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.X}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);this.h.cookie=a+"="+b+(f?";domain="+f:"")+(g?";path="+g:"")+(0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString())+(d?";secure":"")+(null!=e?";samesite="+e:"")};
...
Z:c});Nf=!1}}
function Zf(a,b){a.requestTimeMs=String(b);S("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);var c=Q("EVENT_ID",void 0);if(c){var d=Q("BATCH_CLIENT_COUNTER",void 0)||0;d||(d=Math.floor(Math.random()*Gf/2));d++;d>Gf&&(d=1);me("BATCH_CLIENT_COUNTER",d);c={serializedEventId:c,clientCounter:String(d)};a.serializedClientEventId=c;Hf&&If&&S("log_gel_rtt_web")&&(a.previousBatchInfo={serializedClientEventId:Hf,roundtripMs:String(If)});Hf=c;If=0}}
...
function dg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Ia||Q("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().Ha:b=zc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
fg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.h)try{this.h.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Ed(b))}catch(f){return}else e=escape(b);b=this.i;pc.set(""+a,e,{X:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
fg.prototype.get=function(a,b){var c=void 0,d=!this.h;if(!d)try{c=this.h.get(a)}catch(e){d=!0}if(d&&(c=pc.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
fg.prototype.remove=function(a){this.h&&this.h.remove(a);var b=this.i;pc.remove(""+a,"/",void 0===b?"youtube.com":b)};var gg;function hg(){gg||(gg=new fg("yt.innertube"));return gg}
...
x(V,U);function tg(a){V.call(this,"MISSING_OBJECT_STORE",{Oa:a},qg.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,tg.prototype)}
...
dbName:b});Object.setPrototypeOf(a,U.prototype);a.args=[{name:"IdbError",Pa:a.name,dbName:b,objectStoreNames:c}];return a}
...
function jh(a){window.addEventListener("online",function(){a.l=!0;a.i&&Cd(a,"ytnetworkstatus-online");kh(a);if(a.s&&S("offline_error_handling")){var b=fh().get("errors",!0);if(b){for(var c in b)if(b[c]){var d=new U(c,"sent via offline_errors");d.name=b[c].name;d.stack=b[c].stack;d.level=b[c].level;qe(d)}fh().set("errors",{},2592E3,!0)}}})}
...
g.next())if(h=h.value,h.Ka(e)){e=h.weight;break a}e=1}f.sampleWeight=e;e=f;f=u(sh);for(g=f.next();!g.done;g=f.next())if(g=g.value,g.S[e.name])for(m=u(g.S[e.name]),h=m.next();!h.done;h=m.next())if(n=h.value,h=e.message.match(n.regexp)){e.params["params.error.original"]=h[0];m=n.groups;n={};for(k=0;k<m.length;k++)n[m[k]]=h[k+1],e.params["params.error."+m[k]]=h[k+1];e.message=g.Y(n);break}e.params||(e.params={});f=vh();e.params["params.errorServiceSignature"]="msg="+f.i.length+"&cb="+f.h.length;e.params["params.serviceWorker"]=
